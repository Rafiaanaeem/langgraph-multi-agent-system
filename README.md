...
A multi-agent AI system built using LangGraph, FastAPI, and Streamlit. This system utilizes a supervisor-worker architecture to intelligently route user queries to specialized AI agents while maintaining strict state tracking across the conversation. It features a modern, ChatGPT-like web interface for seamless interaction.

1. Key Features

* **Modern Web Interface:** A ChatGPT-like Streamlit frontend featuring custom CSS, glassmorphism design, and color-coded agent badges for a premium user experience.
...
pip install fastapi uvicorn pydantic langchain langchain-core langgraph streamlit requests
